  ...
  const handleSearch = (event) => {
    ...
    if (query !== "") {
      ...
      const filtered = price.filter((p) => {
        ...
        return (
          lowerUnit.includes(query) ||
          lowerName.includes(query) ||
          lowerBrand.includes(query) ||
          lowerModel.includes(query) ||
          lowerRemarks.includes(query)
        );
      });
                  ...
                  ? category.items.map((cat) => {
                      return (
                        <tr key={cat._id}>
                          ...
                          <td>
                            {cat.price_adjustment ? cat.price_adjustment : ""}
                          </td>
                          <td>
                            {cat.net_price
                              .toString()
              ...
              <Grid container spacing={2}>
                <Grid item xs={5}>
                  <Button
                    ...
                    color="primary"
                    size="medium"
                    startIconclassName={classes.button}
                  >
                    {" "}
                    <input {...getInputProps()} />
                  ...
                  <Button
                    ...
                    color="primary"
                    size="medium"
                    startIconclassName={classes.downloadBtn}
